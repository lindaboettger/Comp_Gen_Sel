...
if ! [ $species == 'YRI' ] && ! [ $species == 'gorilla' ]; then
  /seq/vgb/linda/bin/liftOver \
    ...
    $wd/'Betas_'$species'_BetaIn_'$chr'_win'$win'_smoothed_toliftover.bed' \
    $this_chain \
    $liftout/$species'_to_hg19_'${chr}'_win'$win'_smoothed.bed' \
    $liftpath/$species'_to_hg19_'${chr}'_win'$win'_smoothed_Unmapped.bed'
    ...
    echo "I am a fucking gorilla"
      ...
      $liftpath/gorgor4_to_gorgor3_${chr}_smoothed_.bed \
      $liftpath/gorgor4_to_gorgor3_${chr}'_win'$win'_smoothed_Unmapped.bed'
