...
## these have no MHC, and are extended haplotypes
hum_tr = [
        # 0->0, 0->1
        [984714, 17374],
        # 1->0, 1->1
...
if __name__ == '__main__':
    ...
    #change these
    trs = [hum_tr, chi_tr, gor_tr, mus_tr]
...
#python mcmc_general.py >> three_great_apes_noHLA.txt &

#python mcmc_general.py >> chimp_human_transspec.txt &

#python mcmc_general.py >> hum_chp_gor_mus_wi5kb.txt &
